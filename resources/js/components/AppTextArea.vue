...
const textareaClass = () =>
    cn(
        'min-h-28 w-full rounded-md border bg-surface px-3 py-2 text-sm text-on-surface transition placeholder:text-text-secondary disabled:cursor-not-allowed disabled:bg-border-muted disabled:text-text-secondary',
        props.error
